...
Les sites tirent les mises à jour **signées** depuis `dist/` (vérification Ed25519 côté site).
...
Publier une version : `BO_SEC=<clé privée> php build_version.php <version>` puis pousser `dist/**`.
